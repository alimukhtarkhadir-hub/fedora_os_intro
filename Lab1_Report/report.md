...
4. Установить дополнительные программные пакеты и собрать информацию о системе.

# Выполнение лабораторной работы

## Установка системы

Я создал виртуальную машину в программе UTM с названием `khadir_os_intro`. Я выделил 8 ГБ оперативной памяти и 64 ГБ дискового пространства (Рис. 1). 
...
![Создание пользователя khadir](image/user.jpg){#fig:003 width=70%}
...
![Завершение установки программного обеспечения](image/terminal.jpg){#fig:004 width=70%}

## Сбор данных о системе

Я выполнил команды `dmesg` с использованием `sudo` для получения технической информации о системе (Рис. 5).

![Вывод системных данных в терминале](image/dmesg.jpg){#fig:005 width=70%}
